  ...
  tbody.innerHTML = datos.map((p) => `
    <tr>
      ...
      <td><div class="btn-actions">
        ...
        ${p.pdfUrl?`<a class="btn-icon drive" title="Ver PDF en nube" href="${p.pdfUrl}" target="_blank"><i class="fas fa-cloud-download-alt"></i></a>`:`<button class="btn-icon delete" style="background:#f97316" title="Subir PDF a nube" onclick="window._subirPDFManual('permisos','${p.id}')"><i class="fas fa-cloud-upload-alt"></i></button>`}
