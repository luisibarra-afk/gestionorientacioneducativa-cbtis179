  ...
  tbody.innerHTML = datos.map((j) => `
    <tr>
      ...
      <td><div class="btn-actions">
        ...
        ${j.pdfUrl?`<a class="btn-icon drive" title="Ver PDF en nube" href="${j.pdfUrl}" target="_blank"><i class="fas fa-cloud-download-alt"></i></a>`:`<button class="btn-icon delete" style="background:#f97316" title="Subir PDF a nube" onclick="window._subirPDFManual('justificantes','${j.id}')"><i class="fas fa-cloud-upload-alt"></i></button>`}
